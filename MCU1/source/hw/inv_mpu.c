...
#define i2c_write(addre,reg,led,data)       Soft_IIC_Write_Len(&i2c_Dev,addre,reg,led,data)//MPU_Write_Len
#define i2c_read(addre,reg,led,data)        Soft_IIC_Read_Len(&i2c_Dev,addre,reg,led,data)//MPU_Read_Len
#define MPU_IIC_Init()    Soft_IIC_Init(&i2c_Dev)

#define delay_ms    delay_ms//MPU_Delay_ms
